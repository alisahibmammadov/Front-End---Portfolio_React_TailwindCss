        ...
        <div className="sm:flex items-center justify-between md:gap-8">
          ...
          <div className="w-full sm:w-1/2 ">
            <p className="text-gray-300 leading-7 mt-4 sm:mt-0 ">
              ...
              Cupiditate neque error voluptatem tempore officiis fugiat
              veritatis dicta perspiciatis tempora quae.
            </p>
            ...
            <div className="hidden sm:block">
              <div className="flex items-center gap-[10px]">
                ...
                <div className="leading-[20px]">
                  <h2 className="text-gray-200 font-[500] text-[18px]">Alisahib</h2>
                  <p className="text-gray-400 text-[14px] font-[500]">Personal</p>
                </div>
              </div>
            </div>
            <div className="">
              <p className="text-gray-400 text-[14px] ">Copyright {year} developed by Alisahib - All right reserved.</p>
            </div>
          </div>
        </div>
      </div>
